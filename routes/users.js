...
router.post('/', authentication, authorization("admin"), authentication, authorization('admin'), async (req, res) => {
...
router.get(`/get/count`, authentication, authorization('admin','manager'), async (req, res) => {
